...
@Component({
  selector: 'app-formulario-brenda',
  templateUrl: './formulario-brenda.component.html',
  styleUrls: ['./formulario-brenda.component.scss']
})
export class FormularioBrendaComponent implements OnInit {
